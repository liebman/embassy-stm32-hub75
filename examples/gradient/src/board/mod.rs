//! Board- and backend-specific setup for the `gradient` example.
//!
...
#[cfg(not(any(feature = "stm32f722", feature = "stm32h563", feature = "stm32h723")))]
compile_error!("no board selected; enable exactly one of: `stm32f722`, `stm32h563`, `stm32h723`");

#[cfg(all(
    any(feature = "stm32f722", feature = "stm32h563"),
    any(feature = "stm32h563", feature = "stm32h723"),
    any(feature = "stm32h723", feature = "stm32f722"),
))]
compile_error!(
    "multiple board features enabled; enable exactly one of: `stm32f722`, `stm32h563`, `stm32h723`"
);
...
#[cfg(all(
    any(feature = "stm32f722", feature = "stm32h723"),
    any(feature = "gpdma", feature = "gpdma-2d")
))]
compile_error!("`stm32f722` and `stm32h723` have no GPDMA; `gpdma` and `gpdma-2d` are only valid with `stm32h563`");
...
#[cfg_attr(feature = "stm32h723", path = "stm32h723.rs")]
mod chip;
